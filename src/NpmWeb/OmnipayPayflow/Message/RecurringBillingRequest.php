<?php namespace NpmWeb\OmnipayPayflow\Message;
 ...
 */
class RecurringBillingRequest extends AuthorizeRequest
{
    protected $trxtype = 'R'; 
    ...
    public function sendData($data)
    {
        ...
        return $this->response = new RecurringBillingResponse($this, $httpResponse->getBody());
    }
